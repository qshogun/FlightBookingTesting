...
public class DataClass {
    ...
    public static final String signonPageTitle = "Sign-on: Mercury Tours";
    ...
    //login credentials - incorrect password #1
    public static final String passwordIncorrectLowercase = "asdf1234";
